...
export default function PreOrdenesSeleccionarClienteExpress() {
  ...
  const generarPreOrdenExpress = (clienteId) => {
    navigate(`/PreOrdenesDireccionesExpress/${clienteId}`);
  };
    ...
    <div className="page-content">
      <Container fluid>
        <h1 className="text-center titulo-pasos">
          Seleccionar Cliente para Pre-Orden Express
        </h1>
        <Row>
          <Col lg={12}>
            ...
            <Card>
              <CardBody>
                <TablaSeleccionCliente
                  ...
                  generarOrden={generarPreOrdenExpress}
                />
              </CardBody>
            </Card>
          </Col>
