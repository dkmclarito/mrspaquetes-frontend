...
export default function PreOrdenesDireccionesExpress() {
  ...
  const handleContinuar = () => {
    if (selectedDireccion && direccionRecoleccion) {
      ...
      navigate(`/DatosPaquetePreOrdenExpress/${idCliente}`);
    } else {
      toast.warn(
    ...
    <Container fluid>
        ...
        <CardBody>
          <Row>
            <Col lg={12}>
              ...
              <h4>Seleccionar Dirección de Entrega Express</h4>
              <Table responsive>
                <thead>
                  <tr>
                    <th>Dirección</th>
      ...
      {selectedDireccion && direccionRecoleccion && (
        <div>
          ...
          <p>{direccionRecoleccion.direccion || "Dirección no disponible"}</p>
          <Button
