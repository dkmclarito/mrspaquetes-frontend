                    ...
                    {vehiculos.length > 0 ? (
                        vehiculos.map(vehiculo => (
                            <tr key={vehiculo.id}>
                                ...
                                <td className="text-center">{vehiculo.conductor || 'Desconocido'}</td>
                                <td className="text-center">{vehiculo.apoyo || 'Desconocido'}</td>
                                <td className="text-center">{vehiculo.placa}</td>
                                <td className="text-center">{vehiculo.capacidad_carga}</td>
                                <td className="text-center">{vehiculo.estado || 'Desconocido'}</td>
                                <td className="text-center">{vehiculo.marca || 'Desconocido'}</td>
                                <td className="text-center">{vehiculo.modelo || 'Desconocido'}</td>
...
TablaVehiculos.propTypes = {
    vehiculos: PropTypes.arrayOf(PropTypes.shape({
