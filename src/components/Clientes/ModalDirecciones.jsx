  ...
  const cargarDirecciones = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `${API_URL}/direcciones?id_cliente=${clienteId}`,
        {
                ...
                <Table responsive bordered hover>
                  ...
                  <tbody>
                    {direccionesActuales.map((direccion) => (
                      <tr key={direccion.id}>
                        <td
                          style={{ backgroundColor: "#636363", color: "white" }}
                        >
                  ...
                  >
                    <PaginationLink
                      ...
                      style={{
                        borderColor: "white",
                        color:
                          paginaActual === numero + 1 ? "#ffffff" : "#007bff",
                        backgroundColor:
                          paginaActual === numero + 1 ? "#444" : "transparent",
                      }}
                    >
                      {numero + 1}
                    </PaginationLink>
